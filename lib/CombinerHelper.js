...
class CombinerHelper {
  ...
  export(opts = {}) {
    ...
    return this.axios.post(`${this.api}/${targetType}/${config}?${qs}`, file, {
  ...
  flatten(opts = {}) {
    ...
    return this.axios.post(`${this.api}/${targetType}/flatten`, file, {
      headers: { 'Content-Type': 'multipart/form-data' },
    });
  }
  ...
  createConfig(opts = {}) {
    ...
    return this.axios.post(`${this.api}/config/${config}`, payload);
  }
  ...
  updateConfig(opts = {}) {
    ...
    return this.axios.put(`${this.api}/config/${config}`, payload);
  }
